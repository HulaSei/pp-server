...
func (l *ActivateOrderLogic) getTempOrderInfo(ctx context.Context, orderNo string) (*order.TemporaryOrderInfo, error) {
...
func (l *ActivateOrderLogic) getGuestOrderInfo(ctx context.Context, orderInfo *order.Order) (*order.TemporaryOrderInfo, error) {
